+ function ($) {
    ...
    Tabs = function (element, options) {
        this.$element = $(element), this.activeClass = "active", this.tabSelector = "[data-vc-tab]", this.useCacheFlag = void 0, this.$target = void 0, this.selector = void 0, this.$targetTab = void 0, this.$relatedAccordion = void 0, this.$container = void 0
